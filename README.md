...
*   **最小シェル**
    ...
    *   シェル拡張: `set`, `alias`, `repeat`, `layout`, `inputstat`, `about`, `syscall`, `ring3`, `exec`
    ...
    *   `build.ps1` は `hello.r3bin` / `fault.r3bin` / `tick.r3bin` / `argc.r3bin` / `argv0head.r3bin` を `disk/` に自動生成（`tools/generate_r3bin_samples.ps1`）
